    ...
    def generate_train_batch(self):
        ...
        for j, current_key in enumerate(selected_keys):
            ...
            if not force_fg:
                ...
                eligible_classes_or_regions = [i for i in properties['class_locations'].keys() if
                ...
                selected_class_or_region = eligible_classes_or_regions[
                    np.random.choice(len(eligible_classes_or_regions))] if \
            ...
            class_locations = {
                selected_class_or_region: properties['class_locations'][selected_class_or_region][
                                              properties['class_locations'][selected_class_or_region][:,
                                              1] == selected_slice][:, (0, 2, 3)]

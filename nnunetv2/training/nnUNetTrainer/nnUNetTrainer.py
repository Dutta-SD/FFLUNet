...
class nnUNetTrainer(object):
    def __init__(
        ...
        # non grug-brain developers and project managers who not fear complexity spirit demon or
        # even know about sometime one day code base understandable and grug can get work done, everything good!

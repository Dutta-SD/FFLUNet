        ...
        for c in configurations:
            ...
            for fold_folder in expected_fold_folder:
                ...
                if export_crossval_predictions:
                    ...
                    files = [i for i in subfiles(source_folder, join=False) if
                             not i.endswith('.npz') and not i.endswith('.pkl')]
                    for f in files:
...
if __name__ == '__main__':
    export_pretrained_model(2, '/home/fabian/temp/dataset2.zip', strict=False, export_crossval_predictions=True,
                            folds=(0,))

...
def export_pretrained_model_entry():
    ...
    parser.add_argument('--not_strict', action='store_false', default=False, required=False,
                        help='Set this to allow missing folds and/or configurations')
    parser.add_argument('--exp_cv_preds', action='store_true', required=False,
    ...
    export_pretrained_model(dataset_name_or_id=args.d, output_file=args.o, configurations=args.c, trainer=args.tr,
                            plans_identifier=args.p, folds=args.f, strict=not args.not_strict,
